...
<strong>@rtful Batina Creative Studios</strong>
...
<li><a href="<?= artful_e(artful_route('press')) ?>"><?= artful_e((string)t('common.press')) ?></a></li>
...
<li><a href="https://sonekeno.vercel.app" target="_blank" rel="noopener">Sonekeno ↗</a></li>
...
<div class="site-shell site-footer__bottom"><span>© <?= date('Y') ?> Cédric Batina · @rtful Batina Creative Studios</span><span>@rtful Batina Creative Studios <?= ARTFUL_VERSION ?></span></div>
</footer>
